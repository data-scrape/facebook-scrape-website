# Facebook Scrape Website


<div align="center">

[![GitHub stars](https://img.shields.io/github/stars/data-scrape/facebook-scrape-website?style=social)](https://github.com/data-scrape/facebook-scrape-website)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/facebook-scrape-website?style=social)](https://github.com/data-scrape/facebook-scrape-website/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/facebook-scrape-website)](https://github.com/data-scrape/facebook-scrape-website/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/facebook-scrape-website)](https://github.com/data-scrape/facebook-scrape-website/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Facebook scrape website - full Facebook data extraction toolkit


<!-- SEO keywords: facebook scrape website, Facebook Scrape Website, facebook scrape website python, facebook scrape website github -->
...
- Full Facebook website scraping toolkit
- Extract profiles, pages, groups, posts, comments
- Marketplace and event data extraction
- Search results scraping (people, pages, groups)
- Multi-session support with cookie management
- Built-in proxy rotation and rate limiting

## 🎯 Use Cases

All-in-one Facebook data extraction for market research and lead gen.
...
```bash
pip install git+https://github.com/data-scrape/facebook-scrape-website.git
```

### From source

```bash
git clone https://github.com/data-scrape/facebook-scrape-website.git
cd facebook-scrape-website
pip install -e .
```
...
```python
from facebook_scrape_website import Scraper
...
```bash
python facebook_scrape_website.py --query "your-query" --output results.json
```
...
### Is Facebook Scrape Website legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/facebook-scrape-website)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/facebook-scrape-website/issues)
